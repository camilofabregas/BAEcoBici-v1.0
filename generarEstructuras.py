def generarUsuarios(usuarios):
	if usuarios:
		usuarios.clear()
	dni = [41587459, 40902958, 17331253, 24748234, 31933841]
	pin = ["1010", "1515", "1010", "7423", "1238"]
	nomApe = ["camilo_fabregas", "agustina_manduca", "carla_martinez", "damian_gomez", "marta_diaz"]
